module.exports = function(grunt) {
	...
	grunt.initConfig({
		...
		jshint: {
			...
			files: {
		        src: ['js/timber.js', 'js/jquery.tm.swipe.js', 'js/jquery.tm.avalanche.js', 'js/jquery.tm.summit.js', 'js/jquery.tm.snowbridge.js', 'js/jquery.tm.horizon.js', 'js/jquery.tm.retinize.js', 'js/jquery.tm.eqalize.js', 'js/jquery.tm.counter.js', 'js/jquery.tm.socialize.js', 'js/jquery.tm.preloadpage.js', 'js/template-functions.js']
			}
		}
	});
